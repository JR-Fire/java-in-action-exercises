...
/**
 * User: jr-fire Date: Nov 6, 2010 Time: 7:08:41 AM
 */
public class Employee implements IEmployee {
	...
	public Employee(String firstName, String lastName, int age,
			String position, BigDecimal pay) {
	...
	public Employee(IEmployee employee) {
		this(employee.getFirstName(), employee.getLastName(),
				employee.getAge(), employee.getPosition(), employee.getPay());
	}
	...
	public String toString() {
		return String.format("%12s\t%20s\t%3d\t%20s\t%s", getFirstName(),
				getLastName(), getAge(), getPosition(), NumberFormat
						.getCurrencyInstance().format(getPay()));
	}
}
